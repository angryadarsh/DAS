      ...
      <div class="-mx-4 flex flex-wrap">
        <div class="w-full px-4">
          <div
            ...
            <div class="mb-10 text-center md:mb-0">
            ...
            <a href="<?= \yii\helpers\Url::to(['site/request-password-reset']) ?>" class="mb-2 inline-block text-base text-dark hover:text-primary hover:underline dark:text-white">
              Forget Password?
            </a>
            <p class="text-base text-body-color dark:text-dark-6">
              <span class="pr-0.5">Not a member yet?</span>
              <a href="<?= \yii\helpers\Url::to(['site/signup']) ?>" class="text-primary hover:underline">
                Sign Up
              </a>
            </p>
